...
namespace SmeData.Mobile.CustomControls
{
    ...
    public partial class FrameButtonHorizontal
    {
        ...
        public static readonly BindableProperty OpacityImageProperty = BindableProperty.Create(nameof(OpacityImage),
            typeof(string),
            typeof(FrameButtonHorizontal));
        ...
        public string OpacityImage
        {
            get => (string)GetValue(OpacityImageProperty);
            set => SetValue(OpacityImageProperty, value);
        }
